...
// ---------------------------------------------------------------------------
// RS-0 — Radix Tooltip wrapper. Used by RS-5 (run-level badge clickable
// affordance) and RS-6 (cost ticker hover detail). Default delay 200ms
// matches our `transition-smooth` token.
// ---------------------------------------------------------------------------
