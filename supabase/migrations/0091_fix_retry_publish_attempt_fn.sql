-- =============================================================================
-- 0091 — Fix retry_publish_attempt function.
--
-- Migration 0076 created retry_publish_attempt without company_id in the
-- social_publish_attempts INSERT. Migration 0074 made company_id NOT NULL,
-- so retrying any attempt throws a NOT NULL violation. This migration
-- replaces the function body with company_id added from v_master.company_id.
-- =============================================================================
