-- =============================================================================
-- 0092 — Fix retry_publish_attempt ambiguous column references.
--
-- Migration 0091 introduced table aliases inconsistently: the first SELECT
-- (social_publish_attempts) and second SELECT (social_publish_jobs) were
-- missing aliases, causing "column reference 'publish_job_id' is ambiguous"
-- because the RETURNS TABLE output column has the same name as the table
-- column. This migration adds aliases `a` and `j` to those two queries.
-- =============================================================================
