...
> Moved from `docs/PARALLELISM_PLAN.md` 2026-05-09 as part of the
> harness restructure. The original path is now a one-line redirect.
> CLAUDE.md §"Parallelism" keeps a six-line summary; this file is
> the canonical reference plus the bootstrap prompt.
